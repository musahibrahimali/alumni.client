...
import { CopyRight, ToggleButton } from "../../widgets/widgets";
                                    ...
                                    <div>
                                        <Link href="/client/home">
                                            <a>
                                                ...
                                                <h1 className="text-gray-50 text-lg font-black">Alumni</h1>
                                            </a>
                                        </Link>
                                    </div>
                            ...
                            <div className="mt-6 lg:mt-0 lg:flex-1">
                                <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="#" className="block mt-2 text-sm text-gray-400 hover:text-gray-200  dark:text-gray-400 hover:underline">Mega
                                            cloud</a>
                                        <a href="#" className="block mt-2 text-sm text-gray-400 hover:text-gray-200  dark:text-gray-400 hover:underline">Aperion
                                            UI</a>
                                        <a href="#" className="block mt-2 text-sm text-gray-400 hover:text-gray-200  dark:text-gray-400 hover:underline">Material
                                            UI</a>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <a href="#" className="block mt-2 text-sm text-gray-400 hover:text-gray-200  dark:text-gray-400 hover:underline">Texh</a>
                                        <a href="#" className="block mt-2 text-sm text-gray-400 hover:text-gray-200  dark:text-gray-400 hover:underline">Next
                                            js</a>
                                        <a href="#" className="block mt-2 text-sm text-gray-400 hover:text-gray-200  dark:text-gray-400 hover:underline">Material
                                            UI</a>
                                    </div>
                            ...
                            <div>
                                <Link href="/client/home">
                                    <a>
                                        ...
                                        <h1 className="text-gray-50 mr-4 md:text-lg font-black">Alumni</h1>
                                    </a>
                                </Link>
                            </div>
