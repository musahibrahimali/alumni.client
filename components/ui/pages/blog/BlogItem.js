    ...
    return (
        <>
            <div className="p-4 md:w-1/3">
                <div className="h-full cursor-default hover:shadow-md border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                    <Image
                    ...
                    <div className="p-6">
                        ...
                        <div className="flex items-center flex-wrap ">
                            <a href="/blog" className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">
                                Learn More
                            ...
                            <span className="text-gray-400 inline-flex items-center leading-none text-sm">
                                <svg className="w-4 h-4 mr-1" stroke="currentColor" strokeWidth="2" fill="none"
                                  ...
                                  <path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3
                                        21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48
                                         8.48 0 018 8v.5z"/>
                                </svg>6
                            </span>
                        </div>
