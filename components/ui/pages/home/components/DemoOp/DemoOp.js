                ...
                <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    ...
                    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left
                        ...
                        <div className="flex flex-col text-center w-full mb-12">
                            <h1 className="sm:text-3xl text-2xl capitalize font-medium title-font mb-4 text-gray-900">
                                Subscribe to our newsletter
                            </h1>
                            <p className="lg:w-2/3 mx-auto text-center text-gray-700">
                        ...
                        <div className="flex w-full md:justify-start justify-center items-end">
                            <div className="relative flex-grow w-full mx-4">
