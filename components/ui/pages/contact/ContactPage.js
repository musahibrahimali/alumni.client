...
function ContactPage() {
    return (
        <>
            ...
            <div className="bg-white dark:bg-gray-900 text-gray-100 px-8 py-24">
                <section className="text-gray-600 body-font relative">
                    <div className="container bg-white shadow-md px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                        <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex
                                        items-end justify-start relative">
                        ...
                        <div
                            className="lg:w-1/3 md:w-1/2 bg-white px-4 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                            ...
                            <div className="relative mb-4">
                                ...
                                <textarea
                                    ...
                                    className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500
                                                focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none
                            ...
                            <p className="text-xs text-center text-gray-500 mt-3">
                                Chitchats blog helvetica fourscore iceland
